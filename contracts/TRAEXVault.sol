    ...
    ITRAEXVault
{
    ...
    function initialize(
        ...
        __ERC20_init("TRAEX T-Bills", "TxBILL");
        ...
        _setMinTxsFee(35 * 10 ** decimals()); // 35USDC
    }
    ...
    function fundTxBILLPurchase(
        ...
        emit FundTxBILLPurchase(_treasury, assets);
    }
